...
import { Mail, Phone, Loader2, KeyRound, CheckCircle2, ArrowLeft } from "lucide-react";
          ...
          {mode === "email" && emailSent ? (
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="font-display text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">
                  Check your email
                </h3>
                <p className="text-sm text-zinc-500 dark:text-zinc-400">
                  We've sent a secure login link to <br />
                  <span className="font-medium text-zinc-900 dark:text-zinc-200">{email}</span>. <br/>
              ...
              <div className="flex w-full flex-col gap-3 pt-4">
                <Button
                  ...
                  disabled={loading}
                  variant="outline"
                  className="h-14 w-full rounded-2xl border-zinc-200 bg-transparent text-base font-medium text-zinc-700 hover:bg-zinc-50 dark:border-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-800/50"
                >
                  {loading ? (
                ...
                <button
                  ...
                  className="flex items-center justify-center text-sm font-medium text-zinc-500 transition-colors hover:text-zinc-900 dark:hover:text-zinc-300"
                >
